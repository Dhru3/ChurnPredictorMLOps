...
def generate_retention_strategy(customer_data, prediction, probability, top_factors):
    ...
    try:
        ...
        # 3. Initialize the model (gemini-2.0-flash-exp is the latest fast model)
...
def main():
    ...
    with col2:
        st.info("🚀 **Active Model**: v1.0 (churn_pipeline.pkl) | **Powered by**: Google Gemini 2.0 Flash")
    ...
    if customer_data is None:
        ...
        - **✨ Generative AI**: Google Gemini 2.0 Flash creating personalized retention emails
        ...
        **🟢 Low Risk Customer (Will Stay):**
        ...
        with col4:
            st.metric("🤖 AI Model", "Gemini 2.0 Flash", help="Google AI-powered generation")
        ...
        if prediction == "Yes":
            ...
            st.info("🤖 This email was personalized using Google Gemini 2.0 Flash based on customer segment, risk level, and specific pain points.")
    ...
    <p style='font-size: 0.9rem;'>Powered by MLflow + SHAP + Google Gemini 2.0 Flash</p>
